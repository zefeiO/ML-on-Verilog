...
from driver.common import Message, send, stream_dataset, send_model
...
async def run_single_board(next_host, next_port, model_name):
    ...
    for _ in range(10):
        sample_cnt = 1000
        input_set, _ = prepare_input_set(model_name, sample_cnt)
